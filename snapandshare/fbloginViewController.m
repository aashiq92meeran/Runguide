...
- (void)loginViewFetchedUserInfo:(FBLoginView *)loginView
   ...
   NSManagedObject *newaddress=[[NSManagedObject alloc]initWithEntity:entity insertIntoManagedObjectContext:context];
   [newaddress setValue:self.nameLabel.text forKey:@"name"];
